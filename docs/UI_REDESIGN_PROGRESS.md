...
| 1 — Design system | `ui-redesign/design-system` | 🔄 In review | (see PR) | Tokens, theme, 21-widget kit, golden gallery; PR open into integration branch |
| 2 — Navigation shell / auth | `ui-redesign/navigation-shell` | ⏸ Not started | — | |
